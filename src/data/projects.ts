...
`,
    ...
    challenges: [
      // TODO: このプロジェクトでの技術的な挑戦や課題を記載してください。
      // 例: '複雑な状態管理の実装', 'Canvasを用いたグラフ描画の最適化'など
    ],
  },
  {
    id: 'studynote2',
...
`,
    ...
    challenges: [
      // TODO: このプロジェクトでの技術的な挑戦や課題を記載してください。
      // 例: 'アプリ内課金の導入', '前作からのデータ移行処理の実装'など
    ],
  },
  {
...
`,
    ...
    challenges: [
      // TODO: このプロジェクトでの技術的な挑戦や課題を記載してください。
      // 例: 'クライアントとの要件定義', 'VBAシステムとのデータ連携'など
    ],
  },
  {
    id: 'flima-manager',
...
`,
    ...
    challenges: [
      // TODO: このプロジェクトでの技術的な挑戦や課題を記載してください。
      // 例: 'iPad/iPhone両対応のレスポンシブUI設計', 'DBのパフォーマンス改善'など
    ],
  },
  {
    id: 'country-quiz',
...
`,
    ...
    challenges: [
      // TODO: このプロジェクトでの技術的な挑戦や課題を記載してください。
      // 例: 'Firebase(Firestore)の導入とデータ設計', 'APIから取得したデータの整形'など
    ],
  },
  {
...
`,
    ...
    challenges: [
      // TODO: このプロジェクトでの技術的な挑戦や課題を記載してください。
      // 例: '初めてのSwift/Xcodeでの開発', 'App Storeへの申請プロセス'など
    ],
  },
];
